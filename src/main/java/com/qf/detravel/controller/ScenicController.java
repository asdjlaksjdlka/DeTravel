...
public class ScenicController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "vId", value = "需要的类别id"),
            @ApiImplicitParam(name = "region", value = "需要的地区名称")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "vId", value = "需要的类别id"),
            @ApiImplicitParam(name = "region", value = "需要的地区名称"),
            @ApiImplicitParam(name = "country", value = "需要的国家名称")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "vId", value = "需要的类别id"),
            @ApiImplicitParam(name = "name", value = "需要的景点名称"),
            @ApiImplicitParam(name = "region", value = "需要的地区名称"),
            @ApiImplicitParam(name = "country", value = "需要的国家名称")
    })
